// TEMPORARY diagnostic route — lets us search Cartesia's real voice
// library server-side (where the API key lives) so a voice can be picked
// by actually reading its name/description, not guessed from memory.
// Removed once the real noir voice is chosen and wired into speak.ts.
