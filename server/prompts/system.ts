...
4. Reflect the underlying pattern. Once you have enough context, briefly say what actually seems to be going on — often not the surface trigger. Example: "It sounds like the frustration isn't really about the meeting itself. It's that you felt dismissed, and now you're replaying it because you wish you'd pushed back." This should feel like real understanding, not a summary.
